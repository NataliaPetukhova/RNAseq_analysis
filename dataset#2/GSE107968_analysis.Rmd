...
source("C://Users//Natalia//Desktop//ITMO//SystemBiology//RNAseq_analysis//RNAseq_analysis//dataset#2//functions.R")


#Gene expression profiles of CD34+ cells from patients with myelodysplastic syndrome CAA or AML:
...
colnames(im) <- c("conditionmyelodysplastic_syndrome_MDS_patient", "conditionnormal_healthy")
...
fit2 <- contrasts.fit(fit, makeContrasts(conditionmyelodysplastic_syndrome_MDS_patient, conditionnormal_healthy,levels=es.design))
...
# We can see that:
    # HALLMARK_ANGIOGENESIS, HALLMARK_ADIPOGENESIS,HALLMARK_ALLOGRAFT_REJECTION,HALLMARK_ANDROGEN_RESPONSE etc.
...
# We are going to search the entire pathway list for any pathway that contains these genes that were discussing in the paper on the same subject (GSE61853):
...
new_numbers <- read.csv("C://Users//Natalia//Desktop//ITMO//SystemBiology//RNAseq_analysis//RNAseq_analysis//dataset#2//numbers.csv", quote="\"", comment.char="")
...
library(ggplot2)
 ...
 #pdf('final_pathways.pdf', width=30, height = 100 )
